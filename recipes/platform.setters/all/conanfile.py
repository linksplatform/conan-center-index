...
class PlatformSettersConan(ConanFile):
    ...
    def _subfolder_sources(self):
        return os.path.join(self.source_folder, "cpp", "Platform.Setters")
    ...
    def package_info(self):
        ...
        self.cpp_info.set_property("cmake_file_name", "Platform.Setters")
        self.cpp_info.set_property("cmake_target_name", "Platform.Setters::Platform.Setters")
