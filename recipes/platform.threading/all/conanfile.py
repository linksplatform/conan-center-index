...
class PlatformInterfacesConan(ConanFile):
    name = "platform.threading"
    license = "MIT"
    homepage = "https://github.com/linksplatform/Threading"
    url = "https://github.com/conan-io/conan-center-index"
    description = "platform.threading is one of the libraries of the LinksPlatform modular framework, " \
                  "to ensure threading"
    topics = ("linksplatform", "cpp20", "threading", "any", "ranges", "native")
    ...
    def _internal_cpp_subfolder(self):
        return os.path.join(self._source_subfolder, "cpp", "Platform.Threading")
