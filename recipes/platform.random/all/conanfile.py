...
class PlatformSettersConan(ConanFile):
    ...
    description = """LinksPlatform's Platform.Random is a library that contains set of C++ class 
    templates. Each setter provides a set of callback methods to set the result value. Use Platform.Random.h file 
    to include the library."""
    topics = ("linksplatform", "platform", "random", "concepts", "header-only")
    settings = "compiler"
    no_copy_source = True
