...
class PlatformCollectionsMethodsConan(ConanFile):
    ...
    def _subfolder_sources(self):
        return os.path.join(self.source_folder, "cpp", "Platform.Collections.Methods")
    ...
    def package_info(self):
        ...
        self.cpp_info.set_property("cmake_file_name", "Platform.Collections.Methods")
        self.cpp_info.set_property("cmake_target_name", "Platform.Collections.Methods::Platform.Collections.Methods")
        self.cpp_info.names["cmake_find_package"] = "Platform.Collections.Methods"
        self.cpp_info.names["cmake_find_package_multi"] = "Platform.Collections.Methods"